...
# EMAIL PROPERTIES 
 # Set the recipients of the report. 
  $users = "Server.Alert.India@allscripts.com"
  $cc = ""
...
# REPORT PROPERTIES 
 # Path to the repor. This is where the report will save to!
	$reportPath = "C:\adscripting\report"; 
...
# SERVER LIST PROPERTIES
	# Get computer list to check disk space. This is just a plain text file with the servers listed out.
	 $computers = Get-Content "C:\adscripting\system.txt"; 
...
$header = " 
  ...
  <title> Daily DiskSpace Report</title> 
  <STYLE TYPE='text/css'> 
  <!-- 
  td { 
   font-family: Tahoma; 
...
# Set background color to Red if space is Critical 
  ...
  # Set background color to Green if space is Healthy 
...
# SMTP PROPERTIES
# SMTP Server settings that will allow the report to be emailed to you. I have this pointing to my Exchange Server which has SMTP enabled
  #$smtpServer = "corpexcasarray01.corp.allscripts.com"
  $smtpServer = "intrelay.corp.allscripts.com" 
  $smtp = New-Object Net.Mail.SmtpClient($smtpServer) 
  $msg = New-Object Net.Mail.MailMessage 
  $msg.To.Add($user)
  #$msg.CC.Add($cc)
        $msg.From = "ADhealthCheck@allscripts.com"
  $msg.Subject = "Allscripts.Com Active Directory Monthly DiskSpace Report for $titledate" 
        $msg.IsBodyHTML = $true 
